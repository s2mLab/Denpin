...
switch model
    ...
    case 101 % SkinAndBrace model: Scapula/Humerus using skin markers without the pins 
        % All the markers except for technical ones
        param.qutilises{1} = [1:6 7:12 13:18];
        param.qbloques{1} = [];
        param.MarkFaux{1} = 10:12;
        param.NDDL = 18;
    ...
    case 101.1 
        ...
        param.qutilises{1} = [1:6 7:12 13:18];
        param.qbloques{1} = [];
        param.MarkFaux{1} = [10:12 14:17 20:29]; 
        param.NDDL = 18;
        
    case 102 % Pins model: Scapula/Humerus using pins markers without the skin markers
        param.qutilises{1} = [1:6 7:12 13:18];
        param.qbloques{1} = [];
        param.MarkFaux{1} = [9:12 17:18];
        param.NDDL = 18;
